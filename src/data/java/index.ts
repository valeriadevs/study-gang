...
export const java14Course: Course = {
  id: 'java-14',
  name: 'Java Mastery',
  subtitle: '29-Day University Lab Alignment',
  icon: 'coffee',
  color: '#f89820',
  duration: 29,
  dailyMinutes: 120,
  description:
    'High-intensity 29-day program for the B.E. (AIML) Java syllabus. Covers fundamentals through modern Java — recursion, enums, generics, HashMaps, TreeMaps, streams, lambdas, and inner classes. Every day includes concept explanations, doubt clinics, exam alerts, practice editors, quizzes, and flashcards.',
