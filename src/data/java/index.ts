...
export const java14Course: Course = {
  id: 'java-14',
  name: 'Java Mastery',
  subtitle: '14-Day University Lab Alignment',
  icon: 'coffee',
  color: '#f89820',
  duration: 14,
  dailyMinutes: 120,
  description:
    'High-intensity 14-day program for the B.E. (AIML) Java syllabus. Every day includes concept explanations, doubt clinics, exam alerts, practice editors, quizzes, and flashcards — all self-contained within the app.',
