...
export const phase1days: Day[] = [
  ...
  // ======== DAY 3: Scanner — Talking to Your User ========
  {
    ...
    blocks: [
      ...
      { type: 'table', id: 'd3-scan-methods', headers: ['Method', 'What It Reads', 'Stops At', 'User types', 'You get'], rows: [['nextLine()', 'Entire line (with spaces)', 'Enter key', '"Vinay Kumar"', '"Vinay Kumar"'], ['next()', 'One word (no spaces)', 'Space or Enter', '"Vinay Kumar"', '"Vinay"'], ['nextInt()', 'A whole number', 'Space or Enter', '"21"', '21'], ['nextDouble()', 'A decimal number', 'Space or Enter', '"8.75"', '8.75']] },
      ...
      { type: 'quiz', id: 'd3-scan-quiz', title: 'Day 3 Quiz',
        questions: [
          ...
          { id: 'd3-scan-q3', question: 'Which method should you use to read "Vinay Kumar" (first and last name)?', options: ['next()', 'nextLine()', 'nextInt()', 'nextWord()'], correctIndex: 1, explanation: 'next() stops at the first space. nextLine() reads the whole line including spaces.' },
