...
export const sde8Course: Course = {
  ...
  dailyMinutes: 60,
  description:
    'Accelerated 8-day path for Statistics & Data Engineering (25CAI0201). Phase 1 prepares ST-1 (Python wrangling + statistics). Phase 2 prepares ST-2 (Big Data architecture & ETL). Doubt clinics, exam alerts, practice editors, quizzes, and flashcards included.',
