...
export const dbms8Course: Course = {
  id: 'dbms-8',
  name: 'DBMS Speedrun',
  subtitle: '8-Day SQL Mastery',
  icon: 'database',
  color: '#38bdf8',
  duration: 8,
  dailyMinutes: 60,
  description:
    'High-intensity 8-day DBMS programme covering DDL, DML, joins, aggregates, and normalisation theory. Every day includes doubt clinics, exam alerts, practice editors, quizzes, and flashcards — all self-contained.',
