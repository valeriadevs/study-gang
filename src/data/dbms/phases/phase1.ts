...
CREATE TABLE pet (
    ...
    death   DATE
      ...
      { type: 'table', id: 'db1-datatypes', headers: ['Data Type', 'Stores', 'Example Value', 'When to Use'], rows: [['INT', 'Whole numbers', '42, -7, 0', 'IDs, counts, ages'], ['VARCHAR(n)', 'Variable text up to n chars', "'Vinay', 'dog'", 'Names, emails, descriptions'], ['CHAR(n)', 'Fixed-length text', "'M', 'F'", 'Codes, flags — always same length'], ['DATE', 'Date only (no time)', "'2026-07-27'", 'Birth dates, deadlines'], ['DATETIME', 'Date + time', "'2026-07-27 14:30:00'", 'Timestamps, logs'], ['DECIMAL(p,s)', 'Exact decimal numbers', '99.99', 'Money, precise calculations'], ['TEXT', 'Long text (up to 65KB)', 'Long descriptions', 'Articles, comments, notes'], ['BOOLEAN', 'true/false (tinyint(1))', 'TRUE, FALSE', 'Flags, statuses']] },
